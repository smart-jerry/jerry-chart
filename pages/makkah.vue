...
import latLngObj from '~/server/excel/Makkah.json'
export default {
  components: {},
  data() {
    return {}
  ...
  mounted() {
    ...
    console.log(latLngObj, 78)
    var arr = latLngObj.Makkah
    console.log(arr.length, 88)
    var heatmapData = []
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      ...
      center: { lat: 21.41992, lng: 39.845158 },
      zoom: 13,
      mapTypeId: 'roadmap'
    })
